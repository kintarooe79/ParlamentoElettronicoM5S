...
ui.title(function()
    ui.container {
        ...
        content = function()
            ...
            ui.container {
                attr = { class = "span6 text center spaceline2" },
                content = function()
                            ui.container {
            ...
            ui.container {
                attr = { class = "span1 offset1 text-center spaceline2" },
                content = function()
                    ui.field.popover {
                        attr = {
                            dataplacement = "left",
                        ...
                        ui.container {
                            ...
                            content = function()
                                ui.container {
                                    ...
                                    content = function()
                                        ui.container {
                                            attr = { class = "span6 offset3 text-center label label-success" },
                                            content = function()
                                                                        ...
                                                                        ui.container {
                                                                            ...
                                                                            content = function()
                                                                                ui.link {
                                                                                    ...
                                                                                    content = function()
                                                                                                        ui.container {
                                                                                                            attr = { class = "span2 offset1 spaceline2" },
                                                                                                            content = function()
                                                                                                        ...
                                                                                                        ui.container {
                                                                                                            attr = { class = "span4 offset2 text-center spaceline" },
                                                                                                            content = function()
                                                                    ...
                                                                    content = function()
                                                                        ...
                                                                        if resource ~= nil then
                                                                            ...
                                                                            elseif string.find(resource.url, "https://www.youtube.com/watch") then
                                                                                ...
                                                                                trace.debug(code)
                                                                                slot.put('<iframe width=\"640\" height=\"360\" src=\"//www.youtube.com/embed/' .. code .. '\" frameborder=\"0\" allowfullscreen></iframe>')
                                                                            else
            ...
            default = {
              ...
              params = param.get_all_cgi()
						    ...
						    ui.link {
                                                        ...
                                                        view = "revoke",
                                                        id = initiative.id,
                                                        image = { attr = { class = "span3 thumb" }, static = "png/cross.png" },
                                                        content = _ "Revoke initiative"
                                                    }
                                                end
                                            end
                        ...
                        ui.container {
                            ...
                            content = function()
                                ui.container {
                                    ...
                                    content = function()
                                        ui.container {
                                            attr = { class = "span12 text-center label label-fix-size" },
                                            content = function()
